...
public class PlotAxes
    extends AbstractAxes implements MouseListener, MouseMotionListener {
  ...
  public void setTickSpacing(double majorXTickSpacing, double minorXTickSpacing, double majorYTickSpacing, double minorYTickSpacing) {
  ...
  public double[] getTickSpacing() {
    return new double[] {
        majorXTickSpacing, minorXTickSpacing, majorYTickSpacing, minorYTickSpacing};
  }

  public double[] getXTickSpacing() {
    return new double[] {
        majorXTickSpacing, minorXTickSpacing};
  }

  public double[] getYTickSpacing() {
    return new double[] {
        majorYTickSpacing, minorYTickSpacing};
  }
  ...
  public void paintComponent(Graphics z) {
    ...
    if (tickColor != null) {
      ...
      if (this.axesMode == LIN_LIN) {
        for (int i = (int) Math.ceil(xMin / majorXTickSpacing); i <= (int) Math.floor(xMax / majorXTickSpacing); i++) {
          g.drawLine( (int) (i * majorXTickSpacing * xScale + xOffset), (int) (innerHeight + topInset), (int) (i * majorXTickSpacing * xScale + xOffset),
          ...
          if (font != null) {
            ...
            g.setColor(txtColor);
            g.drawString(tickText, (int) (i * majorXTickSpacing * xScale + xOffset - r.getWidth() / 2), (int) (innerHeight + topInset + r.getHeight()) + majorTickLength);
          }
        }
        g.setColor(tickColor);
        for (int i = (int) Math.ceil(xMin / minorXTickSpacing); i <= (int) Math.floor(xMax / minorXTickSpacing); i++) {
          g.drawLine( (int) (i * minorXTickSpacing * xScale + xOffset), (int) (innerHeight + topInset), (int) (i * minorXTickSpacing * xScale + xOffset),
        ...
        for (int i = (int) Math.floor(Math.log(xMin) / Math.log(10.0)); i <= (int) Math.ceil(Math.log(xMax) / Math.log(10.0)); i++) {
          g.drawLine( (int) (i * xScale + xOffset), (int) (innerHeight + topInset), (int) (i * xScale + xOffset), (int) (innerHeight + topInset + majorTickLength));
          if (font != null) {
            String tickText = "" + Math.pow(10.0, i);
            Rectangle2D r = g.getFontMetrics().getStringBounds(tickText, g);
            g.setColor(txtColor);
            g.drawString(tickText, (int) (i * xScale + xOffset - r.getWidth() / 2), (int) (innerHeight + topInset + r.getHeight()) + majorTickLength);
          }
          g.setColor(tickColor);
          for (int k = 1; k < 10; k++) {
            if (k * Math.pow(10.0, i - 1) > xMin && k * Math.pow(10.0, i - 1) < xMax) {
              g.drawLine( (int) ( (Math.log(k * Math.pow(10.0, i - 1)) / Math.log(10)) * xScale + xOffset), (int) (innerHeight + topInset),
                         (int) ( (Math.log(k * Math.pow(10.0, i - 1)) / Math.log(10)) * xScale + xOffset), (int) (innerHeight + topInset + minorTickLength));
            }
          }
        }
      }
      ...
      for (int i = (int) Math.ceil(yMin / majorYTickSpacing); i <= (int) Math.floor(yMax / majorYTickSpacing); i++) {
        g.setColor(tickColor);
        g.drawLine( (int) (leftInset - majorTickLength), (int) ( -i * majorYTickSpacing * yScale + yOffset), (int) ( (int) (leftInset)), (int) ( -i * majorYTickSpacing * yScale + yOffset));
        if (font != null) {
          ...
          g.setColor(txtColor);
          g.drawString(tickText, (int) (leftInset - majorTickLength - r.getWidth() - 5), (int) ( -i * majorYTickSpacing * yScale + yOffset + h / 2));
        }
      }
      g.setColor(tickColor);
      for (int i = (int) Math.ceil(yMin / minorYTickSpacing); i <= (int) Math.floor(yMax / minorYTickSpacing); i++) {
        g.drawLine( (int) (leftInset - minorTickLength), (int) ( -i * minorYTickSpacing * yScale + yOffset), (int) ( (int) (leftInset)), (int) ( -i * minorYTickSpacing * yScale + yOffset));
      }
    }
    if (txtColor != null) {
      // draw text
      ...
      if (xLabel != null) {
        ...
        g.drawString(xLabel, (int) ( (innerWidth - r.getWidth()) / 2 + leftInset), (int) (innerHeight + topInset + 2 * r.getHeight()) + majorTickLength);
      }
      // y-Label
      if (yLabel != null) {
    ...
    if (gridColor != null) {
      ...
      if (this.axesMode == LIN_LIN) {
        for (int i = (int) Math.ceil(xMin / majorXTickSpacing); i <= (int) Math.floor(xMax / majorXTickSpacing); i++) {
          g.drawLine( (int) (i * majorXTickSpacing * xScale + xOffset), (int) (topInset), (int) (i * majorXTickSpacing * xScale + xOffset), (int) (innerHeight + topInset));
        }
      }
      else { // LOG_LIN

        for (int i = (int) Math.ceil(Math.log(xMin) / Math.log(10.0)); i <= (int) Math.floor(Math.log(xMax) / Math.log(10.0)); i++) {
          g.drawLine( (int) (i * xScale + xOffset), (int) (topInset), (int) (i * xScale + xOffset), (int) (innerHeight + topInset));
        }

      }
      for (int i = (int) Math.ceil(yMin / majorYTickSpacing); i <= (int) Math.floor(yMax / majorYTickSpacing); i++) {
        g.drawLine( (int) (leftInset), (int) ( -i * majorYTickSpacing * yScale + yOffset), (int) ( (int) (leftInset + innerWidth)), (int) ( -i * majorYTickSpacing * yScale + yOffset));
      }
    }
    // draw frame
  ...
  private BufferedImage rotateText(String text, Font font, Color txtColor, Color bgColor) {
    ...
    Rectangle2D r = getFontMetrics(font).getStringBounds(text, (new BufferedImage(1, 1, BufferedImage.TYPE_INT_RGB)).getGraphics());
