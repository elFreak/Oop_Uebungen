class Trace {
	...
	public Trace(String className, int hashCode) {
		...
		if (showTrace)
			System.out.println("Attribute des Objektes: " + className + "@" + hashCode + " werden erzeugt.");
	}
	...
	public void constructorCall() {
		if (showTrace) {
			System.out.println("Konstruktor " + className + "::" + className + "():" + className + "@" + hashCode
					+ " wird ausgeführt.");
		}
	}
	...
	public void constructorCall(String constructor) {
		if (showTrace)
			System.out.println("Konstruktor " + className + "::" + constructor + ":" + className + "@" + hashCode
					+ " wird ausgeführt.");
	}
